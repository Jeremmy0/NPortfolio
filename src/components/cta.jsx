...
const Cta = ({text , className,href, IconName }) => {
  ...
  return (
    ...
    // </div>
     <button
  type=""
  className={`py-2 px-3 flex group rounded-md content-center text-center text-lg font-semibold bg-[#27272A] text-white hover:bg-[#27272A] transition-all duration-500 ease-out border-1 border-zinc-300/20 shimmer ${className}`}
>
