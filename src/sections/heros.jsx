    ...
    <div className="py-32 md:py-40 lg:py-52 relative z-0 overflow-x-clip  select-text">
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
        ...
        <HeroOrbit size={430} rotation={-14}>
         <img src={SparkleIcon} className="size-12 text-emerald-300" alt="star" />
        ...
        <HeroOrbit size={550} rotation={20} shouldOrbit orbitDuration="60s">
          <img src={StarIcon} className="size-12 text-emerald-300" alt="star" />
        </HeroOrbit>
      ...
      <div className="container">
        ...
        <div className="flex items-center justify-center flex-col md:flex-row mt-8 gap-4 relative z-10">
          <Link href="#projects" className="flex gap-2 items-center border-black border  py-2 px-4 rounded-full">
          ...
          <Link href="/AyoolaJ_Resume.pdf" download="AyoolaJeremiahResume.pdf">
